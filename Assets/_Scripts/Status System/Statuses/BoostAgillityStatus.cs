...
public class BoostAgillityStatus : BaseStatus
{
    int turnCounter;
    GameObject activeVFX;

    public BoostAgillityStatus(StatusManager statusManager, float intensity, float damageModifier, int duration, GameObject statusVFX) : base(statusManager, intensity, damageModifier, duration, statusVFX)
    {
    }
